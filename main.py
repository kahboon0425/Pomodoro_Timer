...
def start_timer():
    ...
    if reps % 2 == 0:
        # TODO: if it is 2nd/ 4th/ 6th rep:
        count_down(short_break_sec)
        title_label.config(text="Break", fg=RED)
    elif reps % 8 == 0:
        # TODO: If it is the 8th rep:
        count_down(long_break_sec)
        title_label.config(text="Break", fg= PINK)
    else:
        # TODO : If it is 1st/3rd/5th/7th rep:
        count_down(work_sec)
...
def count_down(count):
    ...
    if count > 0:
        ...
        start_timer()
        marks = ""
        # get the work session - one checkmark for every 2 reps - for every work session complete, we get one checkmark
